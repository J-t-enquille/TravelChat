...
interface ActivityPreferencesFormProps {
    onClose: () => void;
    schema: RJSFSchema;
}

export const ActivityPreferencesForm: FC<ActivityPreferencesFormProps> = ({ onClose, schema }) => {
    const { user, setMessages } = useContext(Context);
    const [questionText, setQuestionText] = useState("Please enter your activity preferences.");
